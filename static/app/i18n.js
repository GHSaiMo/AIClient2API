...
const translations = {
    'zh-CN': {
        ...
        'dashboard.routing.nodeName.chatgptWeb': 'ChatGPT Web',
        'dashboard.routing.description.chatgptWeb': 'ChatGPT Web 图像生成与编辑',
        ...
        'oauth.kiro.batchImportInstructions': '请输入 refreshToken，支持纯 Token 或 "Token, 邮箱, 登录方式(Google/GitHub)" 格式，每行一个。系统将自动刷新并生成凭据文件。',
        ...
        'oauth.kiro.refreshTokensPlaceholder': '每行输入一个 refreshToken，也可附带邮箱和方式\n例如:\naorAxxxxxxxx\naorAyyyyyyyy, user@gmail.com, google\naorAzzzzzzzz----user@github.com----github',
        ...
        'oauth.chatgptWeb.batchImport': '批量导入 ChatGPT Web 凭据',
        'oauth.chatgptWeb.batchImportDesc': '批量导入多个 ChatGPT Access/Refresh Token',
        'oauth.chatgptWeb.tokensLabel': 'Token 数据 (JSON / 每行一个 Access Token)',
        'oauth.chatgptWeb.tokensPlaceholder': '请粘贴 Access Token 或包含 refresh_token 的 JSON 数组...',
        'oauth.chatgptWeb.importInstructions': '支持纯文本 Access Token（每行一个）或 JSON 账号对象数组。包含 refresh_token 时将支持自动续期。',
        'oauth.chatgptWeb.noTokens': '请输入有效的 ChatGPT Web Token 数据',
        'oauth.chatgptWeb.importing': '正在导入...',
        'oauth.chatgptWeb.importingProgress': '正在处理: {current} / {total}',
        'oauth.chatgptWeb.importSuccess': '成功导入 {count} 个凭据',
        'oauth.chatgptWeb.importAllFailed': '所有 {count} 个凭据导入失败',
        'oauth.chatgptWeb.importPartial': '部分导入成功: {success} 成功, {failed} 失败',
        'oauth.chatgptWeb.importError': '导入过程中出错',
        'oauth.chatgptWeb.tokenCount': 'Token 数量',
        'oauth.chatgptWeb.startImport': '开始导入',
        'oauth.chatgptWeb.jsonExample': '查看导入格式示例',
    ...
    'en-US': {
        ...
        'dashboard.routing.nodeName.grok': 'Grok Web',
        'dashboard.routing.nodeName.chatgptWeb': 'ChatGPT Web',
        'dashboard.routing.description.chatgptWeb': 'ChatGPT Web Image Generation & Editing',
        ...
        'oauth.kiro.batchImportInstructions': 'Enter refreshTokens, one per line. Supports plain token or "token, email, provider (Google/GitHub)" format. The system will automatically refresh and generate credential files.',
        ...
        'oauth.kiro.refreshTokensPlaceholder': 'Enter one refreshToken per line, optional with email and provider\nExample:\naorAxxxxxxxx\naorAyyyyyyyy, user@gmail.com, google\naorAzzzzzzzz----user@github.com----github',
        ...
        'oauth.chatgptWeb.batchImport': 'Batch Import ChatGPT Web Tokens',
        'oauth.chatgptWeb.batchImportDesc': 'Import multiple ChatGPT Access/Refresh Tokens',
        'oauth.chatgptWeb.tokensLabel': 'Token Data (JSON / one token per line)',
        'oauth.chatgptWeb.tokensPlaceholder': 'Paste Access Tokens or JSON array containing refresh_token...',
        'oauth.chatgptWeb.importInstructions': 'Supports plain Access Tokens (one per line) or JSON account array. Having refresh_token enables automatic renewal.',
        'oauth.chatgptWeb.noTokens': 'Please enter valid ChatGPT Web Token data',
        'oauth.chatgptWeb.importing': 'Importing...',
        'oauth.chatgptWeb.importingProgress': 'Processing: {current} / {total}',
        'oauth.chatgptWeb.importSuccess': 'Successfully imported {count} credentials',
        'oauth.chatgptWeb.importAllFailed': 'Failed to import all {count} credentials',
        'oauth.chatgptWeb.importPartial': 'Partially imported: {success} succeeded, {failed} failed',
        'oauth.chatgptWeb.importError': 'Error during import',
        'oauth.chatgptWeb.tokenCount': 'Token Count',
        'oauth.chatgptWeb.startImport': 'Start Import',
        'oauth.chatgptWeb.jsonExample': 'View JSON format examples',
